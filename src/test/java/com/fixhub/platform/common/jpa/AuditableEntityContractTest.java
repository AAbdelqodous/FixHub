...
// AuditTriggerEntity/Repository/Controller are throwaway fixtures living outside
// com.fixhub.platform
...
@EnableJpaRepositories(
        basePackages = {"com.fixhub.platform", "com.fixhub.testsupport.audittrigger"})
@SpringBootTest
...
class AuditableEntityContractTest {
    ...
    void updateAdvancesUpdatedAtButNotCreatedAt() throws Exception {
        ...
        String reloaded =
                mockMvc.perform(get("/test/audit-trigger/{id}", id))
                        .andReturn()
                        .getResponse()
                        .getContentAsString();
